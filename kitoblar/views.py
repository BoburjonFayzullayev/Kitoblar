...
from kitoblar.forms import BookReviewForm
from kitoblar.models import Book, BookReview
...
class EditReviewView(LoginRequiredMixin, View):
    def get(self, request, book_id, review_id):
        ...
        return render(request, "edit_review.html", {"book": book, "review": review, "review_form": review_form})
